...
class ECG200Dataset(Dataset):
    def __init__(self, root_dir, mode="train", sequence_length=140, truncation=None, random_seed=None):
        
        assert mode in ["train", "test"]
        self.sequence_length = sequence_length
        self.random_seed = random_seed
        file_path = os.path.join(root_dir, "ECG5000_TEST.ts" if mode == "test" else "ECG5000_TRAIN.ts")
